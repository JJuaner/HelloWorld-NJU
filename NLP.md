...
### 文本表示
机器和算法不认识文本，文本需要表示为数字：文本表示
好的文本表示应该能反映更多的语法结构信息


词的基本表示：ID编码onehot向量（高维，正交）/仅仅做区别没有反映语义相似性/没有任何语义信息)->分布表示（SLI，word embedding：word2vec：CBOW/skip-gram
句子文档的基本表示：词袋模型，词onehot向量累加（没有考虑位置和顺序关系）
